...
describe("API Specification", () => {
  ...
  describe("Create a reservation", () => {
    test("200 response should meet spec", async () => {
      ...
      const res = await axios.post("http://localhost:5000/reservations", body, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  describe("Get a single reservation", () => {
    ...
    test("200 response should meet spec", async () => {
      const res = await axios.get(`http://localhost:5000/reservations/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
    ...
    test("400 response should meet spec", async () => {
      const res = await axios.get(
        "http://localhost:5000/reservations/invalid-id",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
    ...
    test("403 response should meet spec", async () => {
      const res = await axios.get(
        "http://localhost:5000/reservations/507f1f77bcf86cd799439011",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
    ...
    test("404 response should meet spec", async () => {
      const res = await axios.get(
        "http://localhost:5000/reservations/000000000000000000000000",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  describe("Get a single restaurant", () => {
    test("200 response should meet spec", async () => {
      const res = await axios.get(
        "http://localhost:5000/restaurants/616005cae3c8e880c13dc0b9"
      );
    ...
    test("400 response should meet spec", async () => {
      const res = await axios.get(
        "http://localhost:5000/restaurants/invalid-id",
        {
          validateStatus: (status) => {
            return status <= 400;
          },
    ...
    test("404 response should meet spec", async () => {
      const res = await axios.get(
        "http://localhost:5000/restaurants/000000000000000000000000",
        {
          validateStatus: (status) => {
            return status <= 404;
          },
